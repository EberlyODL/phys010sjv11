...
If the charge is negative like in the figure above, we get the same shape for the field lines but the arrow is reversed and the electric field now point toward the charge. In the figure below, you can see the electric field lines for a positive and negative charges that are close by. This is called a dipole.
